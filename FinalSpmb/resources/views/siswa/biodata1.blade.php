        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-10 px-4">
                <div class="flex items-center justify-between relative max-w-2xl mx-auto">
                    ...
                    <!-- Step 1 -->
                    <div class="flex flex-col items-center relative z-10 cursor-pointer" >
                    ...
                    <!-- Step 2 -->
                    <div class="flex flex-col items-center relative z-10 cursor-pointer active" >
                    ...
                    <form onsubmit="saveData(event)" id="mainForm">
                        <div id="step-2" class="step-content">
                            <h3 class="text-xl font-bold text-gray-800 mb-6 flex items-center gap-2">
                                <i class="fa-solid fa-school text-primary"></i> Data Sekolah Asal
                            </h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="md:col-span-2">
                                    <label class="block text-sm font-medium mb-1 text-gray-700">Nama Sekolah
                                        Asal</label>
                                    <input type="text"
                                        ...
                                        placeholder="Contoh: SMP Negeri 1 Tugumulyo">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium mb-1 text-gray-700">NPSN Sekolah</label>
                                    <input type="text"
                                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-primary focus:border-primary outline-none">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium mb-1 text-gray-700">Tahun Lulus</label>
                                    <select
